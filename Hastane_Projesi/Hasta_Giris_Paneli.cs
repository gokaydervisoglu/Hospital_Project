...
{
    public partial class Hasta_Giris_Paneli : Form
    {

        public bool key;

        public Hasta_Giris_Paneli()
        {
            InitializeComponent();
        }
        ...
        private void btn_giris_Click_1(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (reader.Read())
                {
                    Hasta_Bilgi_Paneli fr = new Hasta_Bilgi_Paneli();
                    fr.tc = tc_txt.Text;
                    fr.Show();
                    this.Hide();
                    sql.baglanti().Close();
        ...
        {
            Hasta_Kayit_Paneli fr = new Hasta_Kayit_Paneli();
            this.Hide();
            fr.Show();
        }
        ...
        {
            Sifre_Unuttum_Paneli fr = new Sifre_Unuttum_Paneli();
            this.Hide();
            fr.Show();
        }
    }
