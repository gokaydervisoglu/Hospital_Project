...
{
    public partial class Sekreter_Bilgi_Paneli : Form
    {
        private bool key = true;
        public string? tc;
        public Sekreter_Bilgi_Paneli()
        {
            InitializeComponent();
        }
        ...
        {
            Sekreter_Guncelleme_Paneli fr = new Sekreter_Guncelleme_Paneli();
            fr.tc = tc_txt.Text;
            fr.Show();
            this.Hide();
        }
        ...
        {
            Brans_Paneli br = new Brans_Paneli();
            br.Show();
        }
        ...
        {
            Randevu_Listesi_Paneli fr = new Randevu_Listesi_Paneli();
            fr.Show();
        }
        ...
        {
            Sekreter_Duyuru_Paneli fr = new Sekreter_Duyuru_Paneli();
            fr.Show();
        }
    }
}
